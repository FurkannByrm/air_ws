#include "air_led_controller/air_led_controller.hpp"
...
{
  using DriverInfo = air_led_controller::msg::MotorDriverInfo;
  using HardwareInfo = air_led_controller::msg::HardwareInfoArray;
