...
def generate_launch_description():
    ...
    pkg_air_simulator = get_package_share_directory('air_simulator')

    gazebo_models_path, ignore_last_dir = os.path.split(pkg_air_simulator)
    ...
    urdf_file_path = PathJoinSubstitution([
        pkg_air_simulator,  # Replace with your package name
        "urdf",
    ...
    world_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(pkg_air_simulator, 'launch', 'world.launch.py'),
        ),
        launch_arguments={
    ...
    rviz_node = Node(
        package='rviz2',
        executable='rviz2',
        arguments=['-d', PathJoinSubstitution([pkg_air_simulator, 'rviz', LaunchConfiguration('rviz_config')])],
    ...
    gz_bridge_node = Node(
        ...
        arguments=[
            ...
            "scan_merger@sensor_msgs/msg/LaserScan@gz.msgs.LaserScan",
            "scan_0@sensor_msgs/msg/LaserScan@gz.msgs.LaserScan",
    ...
    ekf_node = Node(
        ...
        output='screen',
        parameters=[
            os.path.join(pkg_air_simulator, 'config', 'ekf.yaml'),
            {'use_sim_time': LaunchConfiguration('use_sim_time')},
             ]
    )
